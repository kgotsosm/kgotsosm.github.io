  ...
  return (
    <div className="fixed w-screen h-[80px] flex justify-between items-center px-4 bg-[#08192F] text-gray-300 z-20">
      ...
      <ul className="hidden md:flex">
        <li className="hover:text-[#2097F3]">
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0 items-center">
        <ul className="space-y-8">
          <li className="flex justify-between text-3xl text-gray-300 hover:text-blue-500 transition duration-300 ease-in-out">
            <a
          ...
          <li className="text-3xl text-gray-300 hover:text-yellow-300 transition duration-300 ease-in-out">
            <a
